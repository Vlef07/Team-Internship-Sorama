"""this script plots eat training loss over steps from a csv file written during training"""
import argparse
import os
...
def main():
    # collect knn csv files by checkpoint step and plot overall hmean performance
